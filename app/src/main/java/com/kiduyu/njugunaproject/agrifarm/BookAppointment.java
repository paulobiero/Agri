        ...
        mConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!dateValue.isEmpty()) {
                    ...
                    if (flagChecked == 0) {
                        Toast.makeText(BookAppointment.this, "Please Select time", Toast.LENGTH_SHORT).show();
                      //  FancyToast.makeText(BookAppointment.this, "Please Select time", FancyToast.LENGTH_SHORT, FancyToast.ERROR, false).show();
                        ...
                        String consultant_phone = getIntent().getStringExtra("consultant_phone").toString();
...
//                        String userphone = "0716541458";
                    ...
                    Toast.makeText(BookAppointment.this, "Please Select Date", Toast.LENGTH_SHORT).show();
                  //  FancyToast.makeText(BookAppointment.this, , FancyToast.LENGTH_SHORT, FancyToast.ERROR, false).show();
                }
            }
        });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                         ...
                         //  FancyToast.makeText(getApplicationContext(), jsonObject.getString("message"), FancyToast.LENGTH_LONG,FancyToast.SUCCESS,false).show();
                            Toast.makeText(BookAppointment.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
