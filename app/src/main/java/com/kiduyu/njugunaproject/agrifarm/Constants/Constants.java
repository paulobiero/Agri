...
public class Constants {
    ...
    public static String SPECIALIST_API = "consultant_api.php";
    public static String SPECIALIST_LIST = "appointmentlist.php";

    public static String Baseimageurl = "https://the-bookhub.co.ke/projects/agrifarm/img/";
